...
(function () {
    ...
    function iOr(b) {
        ...
        ;
        for (var a = 0; a < u; a++) {
            var m = z * (a + 285) + (z % 50368);
            var s = z * (a + 319) + (z % 42001);
            var i = m % u;
            var n = s % u;
            var g = x[i];
            x[i] = x[n];
